...
class ImpuestosSheet implements FromQuery, WithHeadings,WithTitle, WithMapping,
WithColumnWidths, ShouldAutoSize, WithColumnFormatting, WithStyles, WithEvents
{
    ...
    public function query()
    {
        ...
        // Aplicamos los filtros recibidos
            $filters = $this->filters;
             ...
             $query->whereHas('auditorias', function ($q) { $q->where('tipo_documento', 'impuestos'); });
    ...
    public function map($operacion): array
    {
        ...
        $pdfFactura = optional($facturaImpuestos)->ruta_pdf
            ? '=HYPERLINK("' . optional($facturaImpuestos)->ruta_pdf . '", "Acceder PDF")'
            : 'Sin PDF!';
