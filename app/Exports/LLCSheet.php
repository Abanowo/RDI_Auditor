...
class LLCSheet implements FromQuery, WithHeadings,WithTitle, WithMapping,
...
WithStrictNullComparison
{
    ...
    public function query()
    {
        ...
        // --- AQUÍ APLICAMOS LOS FILTROS DINÁMICAMENTE ---
            ...
            $query->whereHas('auditorias', function ($q) { $q->where('tipo_documento', 'llc'); });
    ...
    public function map($operacion): array
    {
        ...
        $pdfFactura = optional($facturaLLCs)->ruta_pdf
            ? '=HYPERLINK("' . optional($facturaLLCs)->ruta_pdf . '", "Acceder PDF")'
            : 'Sin PDF!';
        ...
        return [
            ...
            $operacion->pedimento,
            'CLIENTE PLACEHOLDER',
            (float) $facturaLLCs->monto_total,
            (float) $facturaLLCs->monto_total_mxn,
            $montoSc,
            $montoScMxn,
            $monedaConTC,
            $facturaLLCs->folio,
