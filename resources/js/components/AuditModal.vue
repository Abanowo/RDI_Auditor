<template>
  ...
  >
    <div
      class="bg-white rounded-lg shadow-2xl w-full max-w-7xl flex flex-col"
      style="height: 90vh"
    >
          ...
          <div class="w-full lg:w-1/2 space-y-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div class="bg-gray-50 p-4 rounded-lg">
                ...
                <p class="text-2xl font-semibold text-theme-dark truncate" :title="scMainData.folio">{{ scMainData.folio }}</p>
              </div>
...
export default {
  ...
  computed: {
     ...
     */
    montoFactura() {
      if (this.isScAudit || !this.auditData?.factura) {
        return {};
      }
      return {
    ...
    montoEsperadoSc() {
      if (this.isScAudit || !this.auditData?.sc) {
        return {};
      }
