<template>
  <div v-if="mostrar" class="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-70 p-4 md:p-8">
    ...
    <div class="bg-white rounded-xl shadow-2xl w-full max-w-6xl flex flex-col h-[90vh] overflow-hidden">
      ...
      <div class="bg-[#2A3A4D] px-6 py-4 flex justify-between items-center shrink-0 shadow-md z-10">
        ...
        <button @click="cerrar" class="text-gray-400 hover:text-white transition-colors bg-gray-700 hover:bg-gray-600 rounded-full p-2">
